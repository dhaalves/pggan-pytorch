...
## general settings.
parser.add_argument('--train_data_root', type=str, default='/home/daniel/pggan-pytorch/dataset')
parser.add_argument('--output_dir', type=str, default='/home/daniel/pggan-pytorch/results')
